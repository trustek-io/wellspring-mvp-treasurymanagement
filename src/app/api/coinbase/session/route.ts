...
import { generateJWT } from '@/app/utils/sessionTokenApi'
...
export async function POST(request: NextRequest) {
    try {
        ...
        const keyName = process.env.CDP_API_KEY_NAME || Resource?.CDP_API_KEY_NAME?.value
        const keySecret = process.env.CDP_API_KEY_PRIVATE_KEY || Resource?.CDP_API_KEY_PRIVATE_KEY?.value
